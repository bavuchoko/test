...
import egovframework.fileManager.EgovFileTool;
...
public class FileManageDAO extends EgovComAbstractDAO {
	...
	public void deleteFileInfs(List<?> fileList) throws Exception {
		...
		while (iter.hasNext()) {
			...
			String filePath = fileStorePath + vo.getFileStreCours() + vo.getStreFileNm();
	...
	public void deleteFileInf(FileVO fvo) throws Exception {
		...
		String filePath = fileStorePath + fvo.getFileStreCours() + fvo.getStreFileNm();
	...
	public List selFileList(FileVO fileVO) throws Exception{
		return list("FileManageDAO.selFileList", fileVO);
	}
	
	public void delFile(FileVO fileVO) throws Exception{
		delete("FileManageDAO.delFile", fileVO);
	}
	
	public void delFileCom(String atchFileId) throws Exception{
		delete("FileManageDAO.delFileCom", atchFileId);
	}
}
