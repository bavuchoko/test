...
public class EgovFileMngServiceImpl extends EgovAbstractServiceImpl implements EgovFileMngService {
	 ...
	 * 여러 개의 파일을 삭제한다.
	 *
	 * @see egovframework.com.cmm.service.EgovFileMngService#deleteFileInfs(List)
	 */
	 ...
	 *
	 * @see egovframework.com.cmm.service.EgovFileMngService#insertFileInfs(List)
	 */
	 ...
	 *
	 * @see egovframework.com.cmm.service.EgovFileMngService#updateFileInfs(List)
	 */
	...
	public List selFileList(FileVO fileVO) throws Exception{
		return fileMngDAO.selFileList(fileVO);
	}
	
	public void delFile(FileVO fileVO) throws Exception{
		fileMngDAO.delFile(fileVO);
	}
	
	public void delFileCom(String atchFileId) throws Exception{
		fileMngDAO.delFileCom(atchFileId);
	}
}
